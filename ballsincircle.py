...
# draw the circle
mycircle = N.array([[1.01*N.cos(2*N.pi*ii/1000),
    1.01*N.sin(2*N.pi*ii/1000)] for ii in range(1000)]).T
...
eps           = 1e-2    # distance between adjacent balls
...
print('All ball paths are calculated')
